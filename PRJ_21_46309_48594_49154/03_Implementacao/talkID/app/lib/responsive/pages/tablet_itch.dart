...
class TabletItchPage extends StatefulWidget {
  const TabletItchPage({super.key});

  @override
  State<StatefulWidget> createState() => _TabletItchPageState();
}

class _TabletItchPageState extends State<TabletItchPage> {
