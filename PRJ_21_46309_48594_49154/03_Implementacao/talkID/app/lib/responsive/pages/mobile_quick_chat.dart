...
class MobileQuickChatPage extends StatefulWidget {
  const MobileQuickChatPage({super.key});

  @override
  State<StatefulWidget> createState() => _MobileQuickChatPageState();
}

class _MobileQuickChatPageState extends State<MobileQuickChatPage> {
      ...
      body: OrientationBuilder(
        builder: (context, orientation) {
          ...
          EdgeInsetsGeometry margin = orientation == Orientation.portrait
              ...
              : const EdgeInsets.all(15);
          double iconSize = orientation == Orientation.portrait ? 50 : 44;
