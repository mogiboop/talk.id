...
class TabletComKeyboardPage extends StatefulWidget {
  const TabletComKeyboardPage({super.key});

  @override
  State<StatefulWidget> createState() => TabletComKeyboardPageState();
...
class TabletComKeyboardPageState extends State<TabletComKeyboardPage> {
