...
class TabletLoginPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _TabletLoginPageState();
}

class _TabletLoginPageState extends State<TabletLoginPage> {
  final GlobalKey<_TabletLoginPageState> myWidgetKey = GlobalKey();
    ...
    if (token != null) {
      if (context != null && context.mounted) {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const TabletHomePage()),
        );
      }
    }
  }
