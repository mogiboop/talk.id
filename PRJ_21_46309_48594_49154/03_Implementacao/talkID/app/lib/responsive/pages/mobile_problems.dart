...
class MobileProblemsPage extends StatefulWidget {
  const MobileProblemsPage({super.key});

  @override
  State<StatefulWidget> createState() => _MobileProblemsPageState();
}

class _MobileProblemsPageState extends State<MobileProblemsPage> {
      ...
      body: OrientationBuilder(
        builder: (context, orientation) {
          ...
          if (orientation == Orientation.portrait) {
            ...
            crossAxisCount = 3;
            margin =
                const EdgeInsets.only(bottom: 45, left: 25, right: 25, top: 20);
            iconSize = 44;
          }
